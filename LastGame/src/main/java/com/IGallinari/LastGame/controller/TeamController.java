...
public class TeamController {
    ...
    public StandingsResponse getStandings(@RequestBody TokenRequest tokenRequest, @RequestParam int season){return this.service.buildStandingsResponse(tokenRequest,season);}
}
